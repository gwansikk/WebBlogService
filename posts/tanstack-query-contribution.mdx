---
title: TanStack Query 개발 중 마주친 버그 개선하고 기여하기
description: 프로젝트 개발 도중 마주친 버그를 개선하고 기여하는 에피소드를 이야기합니다.
date: 2024-03-30
thumbnail: /assets/tanstack-query-contribution/tanstack-query.webp
---
...
![TanStack Query 랜딩 페이지](/assets/tanstack-query-contribution/tanstack-query-latest.webp)
...
다른 훅에서도 비슷한 문제가 생긴 것을 확인하고 디버깅 한 결과 skipToken를 사용하면 발생되는 문제였어요. 처음에는 제가 useQueries를 잘못 사용하고 있나 공식 문서도 확인해 봤지만 해결할 수 없었죠. 이 문제가 버그인 지는 깃허브(Github)에 TanStack/Query 이슈를 통해 확신할 수 있었습니다.

# 개발 중 마주친 문제는 버그였다

![PR#7035](/assets/tanstack-query-contribution/PR7035.webp)

useQuerirs에서 skipToken을 사용하면 정상적인 타입 추론이 안되는 버그는 3월 6일 깃허브 이슈를 통해 제보된 상태였어요. 제 환경에서만 겪는 문제가 아니었습니다. (제 코드는 잘못이 없어요ㅜ 흑)
...
![tanstack-query](/assets/tanstack-query-contribution/code.webp)
...
![comment-hint](/assets/tanstack-query-contribution/comment-hint.webp)
...
![comment-skiptoken](/assets/tanstack-query-contribution/comment-skiptoken.webp)
...
![comment-tkdodo](/assets/tanstack-query-contribution/comment-tkdodo.webp)
...
![changelog](/assets/tanstack-query-contribution/changelog.webp)
