...
description: VitePress 컨트리뷰션 하는 에피소드를 이야기합니다.
date: 2024-01-21
thumbnail: /assets/vitepress-contribution/vite-landing-page.webp
---
...
이번 chain이라는 Fetch API 확장 라이브러리를 만들면서 Documentation Framework인 VitePress를 사용하는 중에 필요한 기능을 제안하여 기여하게 된 에피소드를 이야기하고자 해요.

# Documentation Framework는 뭔가요?

![frameworks](../public/assets/vitepress-contribution/framworks.webp)
...
![VitePress 랜딩페이지](../public/assets/vitepress-contribution/vite-landing-page.webp)
...
![NPM 소셜링크](../public/assets/vitepress-contribution/npm-sociallink.webp)
...
![소셜링크 예제](../public/assets/vitepress-contribution/sociallinks-example.webp)
...
![PR935](../public/assets/vitepress-contribution/PR934.webp)

![PR1214](../public/assets/vitepress-contribution/PR1214.webp)
...
![brc-dd-comment](../public/assets/vitepress-contribution/brc-dd-comment.webp)
...
![이슈 생성](../public/assets/vitepress-contribution/my-first-issue.webp)
...
![기여 환영 라벨](../public/assets/vitepress-contribution/contribution-label.webp)
...
![테스트 코드 진행](../public/assets/vitepress-contribution/test-code.webp)

마지막으로 commit-convention.md에 나와있는 커밋 컨벤션을 확인하고 커밋 하여 PR을 보냈습니다. (두근두근)

![PR 보내기](../public/assets/vitepress-contribution/my-pr.webp)

몇 분 후 확인해 보니 빠르게 Merge가 됐어요! 이렇게 저의 인생 첫 오픈소스 프로젝트 기여가 되었습니다.

![기여 완료](../public/assets/vitepress-contribution/commit-log.webp)
...
![체인지로그](../public/assets/vitepress-contribution/changelog.webp)
